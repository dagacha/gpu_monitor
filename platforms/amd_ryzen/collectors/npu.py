...
This is AMD-specific and not part of the shared types (Apple Silicon has no NPU equivalent accessible).
"""
...
class NPUCollector:
    def __init__(self) -> None:
        self._available = os.path.isfile(AMDConfig.XRT_SMI)
    ...
    def _parse_base(self) -> tuple[str, str, str]:
        out = _run([AMDConfig.XRT_SMI, "examine"])
    ...
    def _parse_partitions(self) -> list[NPUPartition]:
        out = _run([AMDConfig.XRT_SMI, "examine", "--report", "aie-partitions"])
