"""
Memory Panel for Apple Silicon.
Shows unified memory breakdown including wired, active, inactive, free.
"""
...
class MemPanel(Widget):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.border_title = "Memory  (Unified)"

    def compose(self) -> ComposeResult:
        # Dynamic rows will be mounted in _update
        yield Static(id="mem-rows")
        yield Static("[dim]Unified memory architecture — no separate GPU/CPU memory[/]", id="mem-note")
